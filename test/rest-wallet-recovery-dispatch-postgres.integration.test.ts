...
suite('recovery dispatch durable liabilities (database history, no canonical-chain claim)', () => {
  ...
  beforeAll(async () => {
    ...
    for (const name of ['004_rest_accounts.sql', '007_rest_smart_accounts.sql', '012_rest_smart_account_onboarding.sql',
      '013_rest_wallet_ceremonies.sql', '014_rest_passkey_onboarding.sql', '015_rest_wallet_enrollment.sql', '041_wallet_passkey_name.sql', '016_rest_wallet_deployments.sql', '036_wallet_deployment_approval_v2.sql',
