...
export async function exerciseRecoveryBrowser(options: {
  ...
  // A direct landing visit lands on the signup page; its sign-in link (either wording) performs the sign-in.
  await page.getByRole('link', { name: /^(log in|Sign in with your passkey)$/ }).click();
