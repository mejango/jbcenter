...
suite("joined wallet signup against real PostgreSQL and unforked EVM", () => {
  ...
  beforeAll(async () => {
    ...
    for (const name of [...new Set([...walletLoginTestMigrations, "016_rest_wallet_deployments.sql",
      ...
      "028_wallet_recovery.sql", "029_wallet_recovery_mapping.sql", "033_wallet_unproved_recovery_expiry.sql", "030_wallet_recovery_flow.sql", "031_wallet_recovery_dispatch.sql"])].sort())
