...
1. Completed journal evidence: two-process PostgreSQL tests cover same/different approval races, one lane and allocation, blocked locks crossing expiry, atomic ceremony consumption, permanent unique nonce, lost claim/persist responses, SQL phase constraints and signing-lease CAS. These tests do not broadcast or settle a transaction.
