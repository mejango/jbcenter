...
try {
  ...
  const lines = [
    ...
    '',
    `${tools.length} V6-only tools are registered. They provide public reads, pure computations, unsigned plan preparation, receipt verification, and explicitly approved publication of a project logo and reviewed project metadata through the integrated Center backend. No tool signs or broadcasts transactions.`,
    '',
