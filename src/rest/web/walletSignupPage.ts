...
<div id="signup-links"><a href="#" id="signup-resume" hidden>Log in</a><a id="signup-fullscreen" target="_top" rel="noopener" hidden>Fullscreen</a></div>
