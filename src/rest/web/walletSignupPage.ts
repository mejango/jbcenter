...
<p class="hint">You'll use your passkey three times: to create it, to check it works, and to approve creating your wallet.</p>
...
<dt id="signup-recovery-label">Recovery</dt><dd id="signup-recovery"></dd><dt>Wallet address</dt><dd id="signup-address"></dd></dl></section>
