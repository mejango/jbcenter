...
<details id="recovery-choice" hidden><summary>Have a wallet already? Use it for recovery instead</summary>
<fieldset id="recovery-method">
<label class="choice"><input type="radio" name="recovery-method" value="kit" checked>Create a recovery kit</label>
<label class="choice"><input type="radio" name="recovery-method" value="wallet">Use my existing wallet</label></fieldset></details>
