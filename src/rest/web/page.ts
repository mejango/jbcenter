...
<p class="lede">A wallet owns your account. Give each bot its own key, permissions, and expiration.</p>
...
<label>Expires in days<input id="bot-days" type="number" min="1" max="365" value="30"></label></div>
