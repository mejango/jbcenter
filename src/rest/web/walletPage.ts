...
p{line-height:1.6;overflow-wrap:anywhere}#wallet-status{color:#53614f;min-height:3rem;margin:1.75rem 0;font-size:.95rem;position:relative}#wallet-status::before{content:"⚡";position:absolute;left:-1.4em;top:0}#wallet-status[data-state=error]::before,#wallet-status[data-state=retry]::before{content:"⚠ "}#wallet-status:empty::before{content:none}
