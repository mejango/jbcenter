...
html.framed main{margin:0 auto;padding:1.25rem calc(1.6rem - 1px + 1.75rem) 1.5rem}html.framed .brand{display:none}html.framed h1{margin-top:.5rem}html.framed #wallet-status{margin:1rem 0}html.framed #wallet-status::before{left:-1.75rem}html.framed #wallet-links{margin-top:1.25rem}
