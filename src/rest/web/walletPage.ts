...
:focus-visible{outline:3px solid #5275d1;outline-offset:4px}.note{font-size:.8rem;color:var(--wallet-muted);margin-top:2rem}#wallet-links{display:flex;flex-wrap:wrap;gap:.75rem 1.5rem;margin-top:1.75rem}html.framed #wallet-open{position:absolute;top:2.2rem;right:var(--wallet-inset)}#wallet-links a,#wallet-open{color:var(--wallet-muted);font-size:.9rem;text-underline-offset:.15em}#wallet-links a:hover,#wallet-open:hover{color:var(--wallet-fg)}#wallet-open-row{margin:0}
