...
html.framed body{visibility:hidden}html.framed.themed body{visibility:visible}html.framed main{margin:0 auto;padding:1.25rem var(--wallet-inset) 1.5rem}html.framed .brand{display:none}html.framed h1{margin-top:.5rem}html.framed #wallet-status{margin:1rem 0}html.framed #wallet-status::before{left:calc(-1 * var(--wallet-inset));width:var(--wallet-inset)}html.framed #wallet-links{margin-top:1rem}
