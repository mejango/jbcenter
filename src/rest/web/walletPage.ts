...
:focus-visible{outline:3px solid #5275d1;outline-offset:4px}.note{font-size:.8rem;color:#53614f;margin-top:2rem}#wallet-links{display:flex;flex-wrap:wrap;gap:.75rem 1.5rem;margin-top:1.75rem}#wallet-links a,#wallet-open-row a{color:#4b5a4e;font-size:.9rem;text-underline-offset:.15em}#wallet-links a:hover,#wallet-open-row a:hover{color:#172019}#wallet-open-row{margin:1rem 0 0}
