...
html.framed body{visibility:hidden}html.framed.themed body{visibility:visible}html.framed main{margin:0 auto;padding:1.25rem var(--wallet-inset) 1.5rem}html.framed .brand{display:none}html.framed h1{margin-top:.5rem}html.framed #wallet-status{margin:1rem 0}html.framed #wallet-status::before{left:calc(-1 * var(--wallet-inset));width:var(--wallet-inset)}html.framed #wallet-links{margin-top:1.25rem}
...
p{line-height:1.6;overflow-wrap:anywhere}#wallet-status{color:var(--wallet-fg);font-weight:700;min-height:3rem;margin:1.75rem 0;font-size:.95rem;position:relative}#wallet-status::before{content:"";position:absolute;left:-1.65em;top:0;width:1.6em;height:1.55em;background:currentColor;-webkit-mask:url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><path d='M13 2 3 14h7l-1 8 10-12h-7z'/></svg>") center/1.15em no-repeat;mask:url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><path d='M13 2 3 14h7l-1 8 10-12h-7z'/></svg>") center/1.15em no-repeat}#wallet-status[data-state=error]::before,#wallet-status[data-state=retry]::before{content:"!";background:none;-webkit-mask:none;mask:none;font-size:1.25em;line-height:1.24em;text-align:center;left:-1.32em;width:1.28em;height:auto}#wallet-status:empty::before{content:none}
#wallet-status[data-state=error],#wallet-status[data-state=retry]{color:#9c3028}#wallet-status a{color:inherit}fieldset{border:0;padding:0;margin:0 0 1.25rem}legend{color:var(--wallet-muted);font-size:.9rem;margin-bottom:.5rem}label.choice{display:flex;gap:.6rem;align-items:center;margin:.4rem 0}#wallet-networks-family{display:flex;gap:1.5rem;flex-wrap:wrap}#wallet-networks-family legend{width:100%}#wallet-networks{line-height:1.6}button.link{all:unset;cursor:pointer;text-decoration:underline;color:var(--wallet-muted);margin-left:.75rem;font-size:.9rem}.actions button.link{margin:0;padding:0;width:auto}button.link:hover:not(:disabled){color:var(--wallet-fg);background:none}#wallet-networks-form{margin:1.5rem 0 2rem}#wallet-networks-form .actions{margin-top:1.5rem}@keyframes spin{to{transform:rotate(360deg)}}#wallet-status[data-state=busy]::before,#wallet-status[data-state=loading]::before,#wallet-status[data-state=checking]::before,#wallet-status[data-state=returning]::before{animation:spin 1s steps(8) infinite}dl{margin:0 0 1.5rem}dt{font-size:.8rem;color:var(--wallet-muted)}dd{margin:.5rem 0 1.2rem;overflow-wrap:anywhere}
