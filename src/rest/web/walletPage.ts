...
<h1>Your Juicebox wallet</h1><p>One wallet for Juicebox apps.</p>
...
p{line-height:1.6;overflow-wrap:anywhere}#wallet-status{color:#53614f;min-height:3rem;margin:1.75rem 0;font-size:.95rem;padding-left:1.7em;text-indent:-1.7em}#wallet-status::before{content:"⚡ "}#wallet-status[data-state=error]::before,#wallet-status[data-state=retry]::before{content:"⚠ "}#wallet-status:empty::before{content:none}
#wallet-status[data-state=error],#wallet-status[data-state=retry]{color:#9c3028}dl{margin:0 0 1.5rem}dt{font-size:.8rem;color:#53614f}dd{margin:.5rem 0 1.2rem;overflow-wrap:anywhere}
