...
p{line-height:1.6;overflow-wrap:anywhere}#wallet-status{color:#53614f;min-height:3rem;margin:1.75rem 0;font-size:.95rem;display:flex;gap:.6em;align-items:flex-start}#wallet-status::before{content:"⚡";flex:none}#wallet-status[data-state=error]::before,#wallet-status[data-state=retry]::before{content:"⚠ "}#wallet-status:empty::before{content:none}
