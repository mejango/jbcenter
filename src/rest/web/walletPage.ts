...
html.framed body{visibility:hidden}html.framed.themed body{visibility:visible}html.framed main{margin:0 auto;padding:1.25rem var(--wallet-inset) 1.5rem}html.framed .brand{display:none}html.framed h1{margin-top:.5rem}html.framed #wallet-status{margin:1rem 0}html.framed #wallet-status::before{left:calc(-1 * var(--wallet-inset) / 2 - .575em)}html.framed #wallet-status[data-state=error]::before,html.framed #wallet-status[data-state=retry]::before{left:calc(-1 * var(--wallet-inset));width:var(--wallet-inset)}html.framed #wallet-links{margin-top:1rem}
...
p{line-height:1.6;overflow-wrap:anywhere}#wallet-status{color:var(--wallet-fg);font-weight:700;min-height:3rem;margin:1.75rem 0;font-size:.95rem;position:relative}#wallet-status::before{content:"";position:absolute;left:-1.425em;top:.2em;width:1.15em;height:1.15em;background:currentColor;clip-path:polygon(54.2% 8.3%,12.5% 58.3%,41.7% 58.3%,37.5% 91.7%,79.2% 41.7%,50% 41.7%)}#wallet-status[data-state=error]::before,#wallet-status[data-state=retry]::before{content:"!";background:none;clip-path:none;font-size:1.25em;line-height:1.24em;text-align:center;top:0;left:-1.36em;width:1.28em;height:auto}#wallet-status:empty::before{content:none}
