...
export type WalletAssertionPurpose = "registration" | "login" | "deploy" | "session" | "payment" | "rotate" | "signup-resume";
...
const PURPOSES = ["registration", "login", "deploy", "session", "payment", "rotate", "signup-resume"];
